...
mkdir("./data/test_models/ICSD19")

# Initialize dataset.
train_dataset = CHGNetDataset(
    path= './data/dataset/icsd/icsd.csv', # train.csv
    name = 'train_MP',
    prop_list = [],
)

val_dataset = CHGNetDataset(
    path= './data/dataset/icsd/icsd.csv', # val.csv
    name = 'val_MP',
    prop_list = [],
)
...
checkpoint_callback = ModelCheckpoint(
    dirpath= './data/test_models/ICSD19/',
...
trainer = pl.Trainer(
    ...
    default_root_dir='./data/test_models/ICSD19/',
    # strategy = 'ddp_find_unused_parameters_true',  # multi-GPU training
)

trainer.fit(model= chggen, datamodule= datamodule)

trainer.save_checkpoint("./data/test_models/ICSD19/trainer_ICSD19.ckpt")
print("Done")