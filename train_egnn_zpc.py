...
train_dataset = CHGNetDataset(
    path= './data/perov_5/test_zpc.csv', # train.csv
    name = 'train_perov',
    prop_list = ['heat_all'],
)

val_dataset = CHGNetDataset(
    path= './data/perov_5/test_zpc.csv', # val.csv
    name = 'val_perov',
    prop_list = ['heat_all'],
)
...
# )
# frac_score_norms = frac_score_norms_interp(
#     datamodule.train_dataloader(), sigmas=sigmas_F,
# )
# with open('./test_models/frac_score_norms_interp.pkl', 'wb') as fp:
