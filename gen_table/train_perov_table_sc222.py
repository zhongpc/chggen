...
from chggen.common.data_utils import get_scaler_from_data_list, get_scaler, mkdir
...
# Initialize dataset.
train_dataset = CHGNetDataset(path= './data/perov_5/sc2_train.csv', # train.csv
name = 'train_perov',
prop_list = ['heat_all'],
)
...
checkpoint_callback = ModelCheckpoint(
    ...
    filename='{sc2-epoch}',        # Save the checkpoint after every epoch
